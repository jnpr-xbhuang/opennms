...
/**
 * The SshWindow class constructs a custom Window component that contains an embedded
 * browser displaying the SSH information of the currently selected node
 * @author Leonardo Bell
 * @author Philip Grenon
 * @version 1.0
 */
public class SshWindow extends InfoWindow {
  ...
  /**
     * The SshWindow method constructs a sub-window instance which can be added to a main window.
     ...
     */
   public SshWindow(final Node node, final URL nodeURL) {
